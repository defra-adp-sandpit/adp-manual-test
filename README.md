...
adp-manual-test Dotnet service.
...
| APPINSIGHTS_CLOUDROLE        | Role used for filtering metrics | no       |         |       | Set to `adp-manual-test-local` in docker compose files                                                                |
...
`docker-compose -p adp-manual-test-test -f docker-compose.yaml -f docker-compose.test.yaml up`
...
`docker-compose -p adp-manual-test-test -f docker-compose.yaml -f docker-compose.test.watch.yaml up`
