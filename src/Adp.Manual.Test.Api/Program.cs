...
using Adp.Manual.Test.Api.AutoMapper;
using Adp.Manual.Test.Api.Config;
using Adp.Manual.Test.Api.Extensions;
...
public static class Program
{
    ...
    public static void ConfigureServices(WebApplicationBuilder builder)
    {
        ...
        {
            config.SwaggerDoc("v1", new OpenApiInfo { Title = "Adp.Manual.Test", Version = "v1" });
        });
